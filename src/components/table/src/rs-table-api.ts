...
import type { RsTableColumn, RsTableRowData } from './utils/table-utils'
...
export interface RsTableApi<T extends RsTableRowData = RsTableRowData> {
  ...
  /** 实例 Feature 贡献的工具条项 */
  getToolbarItems?: () => import('./features/rs-table-feature-host').RsTableToolbarItem[]
  /** 实例 Feature 贡献的 overlay 描述 */
  getOverlayContributions?: () => import('./features/rs-table-feature-host').RsTableOverlayContribution[]
}
