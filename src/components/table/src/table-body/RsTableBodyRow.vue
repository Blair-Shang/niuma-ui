...
import type { RsTableColumn, RsTableRowDropPosition, RsTableSelectionType } from '../utils/table-utils'
import type { RsTableCellEditTrigger } from '../utils/table-edit-utils'
...
defineProps<{
  ...
  rowCommit: boolean
  allowNull: boolean
  focusMode: import('../utils/table-edit-utils').RsTableCellEditFocusMode
  nullLabel: string
...
const emit = defineEmits<{
  ...
  cellNavigate: [colKey: string, direction: import('../utils/table-edit-utils').RsTableCellNavigateDirection]
  rowCommit: []
  rowRollback: []
  gutterCommit: []
}>()
