...
import RsConfigProvider from '../components/config-provider/src/RsConfigProvider.vue'
import RsConfirmDialog from '../components/dialog/src/RsConfirmDialog.vue'
import RsDialog from '../components/dialog/src/RsDialog.vue'
