...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/fieldset', component: () => import('./pages/FieldsetPage.vue') },
    ...
    { path: '/auto-complete', component: () => import('./pages/AutoCompletePage.vue') },
    { path: '/cascader', component: () => import('./pages/CascaderPage.vue') },
    { path: '/tree-select', component: () => import('./pages/TreeSelectPage.vue') },
    { path: '/mentions', component: () => import('./pages/MentionsPage.vue') },
