...
<template>
  ...
  <DocDemo
    ...
    description="插槽名是 edit- 加列 key。update 改草稿，commit 提交，cancel 放弃。"
    description-en="The slot is edit- plus the column key. update changes the draft, commit saves it, and cancel drops it."
